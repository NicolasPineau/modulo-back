...
class EventInvitationRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(EventInvitation $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(EventInvitation $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return EventInvitation[] Returns an array of EventInvitation objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?EventInvitation
    {
        return $this->createQueryBuilder('e')
            ->andWhere('e.exampleField = :val')
            ->setParameter('val', $value)
