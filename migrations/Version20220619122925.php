...
final class Version20220619122925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_invitation_user (event_invitation_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_89417E2D8704CA5C (event_invitation_id), INDEX IDX_89417E2DA76ED395 (user_id), PRIMARY KEY(event_invitation_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
