...
final class Version20220610091034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_event_authorization (id INT AUTO_INCREMENT NOT NULL, role_id INT DEFAULT NULL, type_event_id INT DEFAULT NULL, INDEX IDX_D88088ECD60322AC (role_id), INDEX IDX_D88088ECBC08CF77 (type_event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
