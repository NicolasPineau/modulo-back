...
final class Version20220522130055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE scope (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', structure_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', role_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', is_active TINYINT(1) NOT NULL, INDEX IDX_AF55D3A76ED395 (user_id), INDEX IDX_AF55D32534008B (structure_id), INDEX IDX_AF55D3D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_event (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, is_obligated TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
